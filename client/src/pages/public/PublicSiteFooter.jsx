      ...
      <div className="public-site-footer-main">
        <div className="public-site-footer-brand">
          ...
          <div className="public-site-footer-actions">
            <Link to="/" className="public-site-footer-button secondary">
              Try guest scan
            </Link>
            <Link to="/signup" className="public-site-footer-button primary">
              Create account
            </Link>
          </div>
        </div>
            ...
            <div key={group.title} className="public-site-footer-group">
              ...
              <div className="public-site-footer-list">
                {group.links.map((item) => (
                  <Link key={item.path} to={item.path} className="public-site-footer-link">
                    {item.label}
                  </Link>
                ))}
              </div>
